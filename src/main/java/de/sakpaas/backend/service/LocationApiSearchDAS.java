...
public class LocationApiSearchDAS {
    ...
    public List<OSMResultLocationListDto.OMSResultLocationDto> getLocationByCoordinates(Double latitude, Double longitude,
                                                                                        Double radius) {
    ...
    public OSMResultLocationListDto.OMSResultLocationDto getLocationById(Long id) {
